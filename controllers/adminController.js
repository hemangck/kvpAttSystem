...
module.exports.renderKTaiDBoardHome = async (req, res) => {

    const { name,role } = req.user;

    res.render("user/kTaiDboardHome",{ name,role });
};

module.exports.renderSupVDBoardHome = async (req, res) => {

    const { name,role } = req.user;

    res.render("user/supVDboardHome",{ name,role });
};

module.exports.renderAdminDBoardHome = async (req, res) => {

    const { name,role } = req.user;

    res.render("user/adminDboardHome",{ name,role });
};
