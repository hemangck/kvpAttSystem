...
router.get("/dashboardKTaiHome",isLoggedIn, wrapAsync(adminController.renderKTaiDBoardHome));
router.get("/dashboardSupVHome",isLoggedIn, wrapAsync(adminController.renderSupVDBoardHome));
router.get("/dashboardAdminHome",isLoggedIn, wrapAsync(adminController.renderAdminDBoardHome));
